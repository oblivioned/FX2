...
FX2_ModulesManager_Modifier
{
    ...
    /// @notice 提供一个模块合约与管理员可读写的函数修改器
    modifier ValidModuleAPIAndAdmin()
    {
        require ( FX2_PCImpl.IsSuperOrAdmin(msg.sender) || FX2_MMImpl.IsExistContractVisiter(msg.sender) );
        _;
    }
