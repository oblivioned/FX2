...
contract FX2_ERC20TokenDBS is FX2_BaseDBS
{
    ...
    )
  {
    ...
    {
      investmentAddress[i] = constractVisiters[i].FX2_ContractAddr;
      amounts[i] = _investmentAmountMap[owner][constractVisiters[i].FX2_ModulesName];
    }
  }
